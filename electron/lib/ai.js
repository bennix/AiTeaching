...
async function generateWeeklyPlan(settings, lesson) {
...
const EXERCISE_TYPES = ['choice', 'short_answer', 'coding'];
...
async function generateExercises(settings, lesson, { targetStudentId = null, weakPoints = '', types, count, difficulty } = {}) {
  ...
  const typeLabel = { choice: '选择题', short_answer: '简答题', coding: '编程题' };
...
module.exports = { endpoint, fetchModels, generateExercises, generateStudentReport, generateWeeklyPlan, gradeAnswer, normalizeExerciseOptions, testConnection };
